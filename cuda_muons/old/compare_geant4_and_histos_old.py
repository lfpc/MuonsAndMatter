...
if __name__ == "__main__":
    ...
    for key in data_cuda:
        ...
        plt.hist(geant4_vals, bins=100, density=True, histtype='step', color='firebrick', label='Geant4 (last step)')
        plt.hist(cuda_vals, bins=100, density=True, histtype='step', color='steelblue', label='CUDA')
        plt.xlabel(key)
        plt.ylabel("Density")
    ...
    #plt.hist(np.log(-delta_hist), bins=bins, density=True, histtype='step', color='green', label='Sampling Geant4', log=True)
    plt.hist(np.log(-delta), bins=bins, density=True, histtype='step', color='firebrick', label='Geant4', log=True)
    plt.hist(np.log(-delta_cuda), bins=100, density=True, histtype='step', color='steelblue', label='CUDA', log=True)
    ...
    print(delta_cuda, delta_cuda.shape)
